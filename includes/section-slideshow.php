...
<?php if( get_field('slideshow') ): ?> 
	<section class="module module-slideshow">
		<div class="gallery gallery-main js-flickity" data-flickity-options='{ "lazyLoad": true, "pageDots": false, "autoPlay": 5500, "pauseAutoPlayOnHover": false, "wrapAround": true, "prevNextButtons": false, "cellAlign": "left"}'>
		...
		<div class="gallery gallery-nav js-flickity" data-flickity-options='{ "asNavFor": ".gallery-main", "contain": true, "pageDots": false,  "autoPlay": 5500, "pauseAutoPlayOnHover": false, "wrapAround": true, "cellAlign": "left"}'>
			<?php while ( have_rows('slideshow') ) : the_row(); ?>
