	...
	<section class="module module-products">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<h2 class="text-right"></h2><?php the_field('on_demand_title'); ?> <img src="http://tajmer.dk.linux95.unoeuro-server.com/administrator/wp-content/uploads/2015/12/primary-icon.png" class="img-icon" alt="#"></h2>
					<div class="row">
						<div class="col-md-4">
							<a href="#" title="#"><img src="http://placehold.it/250x350" alt="#" class="img-responsive"></a>
							<a href="#" title="#">Se Tourplan</a>
